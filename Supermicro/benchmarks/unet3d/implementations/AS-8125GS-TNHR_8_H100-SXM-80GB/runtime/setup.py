...
def check_flags(flags, world_size, train_size):
    ...
    if 168 % (flags.batch_size * train_size // flags.spatial_group_size) != 0:
        raise ValueError(f"Current GBS={flags.batch_size * world_size} is not supported. Please select a batch"
                         f"size that is dividing 168 evenly.")
