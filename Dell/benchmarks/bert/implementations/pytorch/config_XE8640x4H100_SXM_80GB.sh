## DL params
#export BATCHSIZE=112 #convergence - 12 mins
#export BATCHSIZE=48 # convergence failed
#export BATCHSIZE=56 # convergence failed
#export BATCHSIZE=64 # convergence failed
export BATCHSIZE=72 # convergence failed
export PACKING_FACTOR=2
export GRADIENT_STEPS=1
export LR=9.6e-4 # best use this 
export MAX_SAMPLES_TERMINATION=4500000
export MAX_STEPS=4500 #- works 
...
source $(dirname ${BASH_SOURCE[0]})/config_XE8640x4H100_SXM_80GB_common.sh
