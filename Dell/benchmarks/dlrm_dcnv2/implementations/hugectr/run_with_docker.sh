...
mllogger.event(key=mllog.constants.CACHE_CLEAR, value=True)"
  ...
  #) |& tee "${_logfile_base}_${_experiment_index}.log"
    ...
    docker exec -it ${_config_env[@]} ${_cont_name} python3 train.py --batchsize 32768 --batchsize_eval 262144 --lr 0.004 --use_mixed_precision --scaler 16348 --gen_loss_summary --sharding_plan auto --dp_sharding_threshold 0.008 --num_gpus_per_node 4 --mem_comm_bw_ratio 7
  ) |& tee "${_logfile_base}_${_experiment_index}.log"
