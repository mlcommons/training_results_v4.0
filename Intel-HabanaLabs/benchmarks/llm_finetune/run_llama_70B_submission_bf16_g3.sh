LIB_TPC_FUSER_ARGS="-mlir-disable-threading" \
PT_HPU_ENABLE_ALLGATHER_SYNC=1 \
LOWER_LIST=ops_bf16.txt \
python scripts/gaudi_spawn.py --world_size 8 --use_deepspeed scripts/train.py \
