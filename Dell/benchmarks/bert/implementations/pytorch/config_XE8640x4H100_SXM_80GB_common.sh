...
## Data Paths
export DATADIR="/mnt/training_ds/bert3.0/hdf5/training-4320/hdf5_4320_shards_varlength"
export DATADIR_PHASE2="/mnt/training_ds/bert3.0/hdf5/training-4320/hdf5_4320_shards_varlength"
export EVALDIR="/mnt/training_ds/bert3.0/hdf5/eval_varlength/"
export CHECKPOINTDIR="./ci_checkpoints"
export RESULTSDIR="./results"
#using existing checkpoint_phase1 dir
export CHECKPOINTDIR_PHASE1="/mnt/training_ds/bert3.0/phase1"
export UNITTESTDIR="/lustre/fsw/mlperf/mlperft-bert/unit_test"


DATADIR_PHASE2_PACKED="/mnt/training_ds/bert3.0/packed_data/"
