...
OmegaConf.register_new_resolver("or", lambda x,y: x or y)
...
def main(cfg) -> None:
    ...
    # TODO: refactor this! This logic is here only to comply with previous checkpoint loading logic from DistributedCheckpointIO
    # this argument handling should be done on config level
