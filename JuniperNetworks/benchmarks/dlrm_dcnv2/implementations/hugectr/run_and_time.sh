...
#${LOGGER} nsys profile -s none -t cuda,nvtx, -f true -o /workspace/dlrm/8node_%h_%p -c cudaProfilerApi --cpuctxsw none --cuda-flush-interval 100 ${DLRM_BIND} python3 ${CONFIG} ${ARGS} | tee /tmp/dlrm_hugectr.log
